...
<body style="background-color: #F5FFFA;">
    <div id="main" style="padding: 0; margin-top: 8px; width: 100%; height: 90%;">
        <div class="m-content" style="width: 1520px; height: 665px;">
            ...
            <p><strong style="font-size:18px; font-family: 'Roboto', sans-serif;"><center>Наряд-задание</center></strong></p>
            <div class="datatable">
                                ...
                                echo "
                                    <tr class='table-data' style='text-align: center;'>
                                        <td>
                                            ...
                                            <form method='post' action='includes/outfitTaskActions/removeOutfitTask.php'>
                                        ...
                                        <td id='kindWork'>" . $row['kindWork'] . "</td>
                                        <td id='jobGiven'>" . $row['jobGiven'] . "</td>
                        ...
                        <div class="addRecord" >
                            ...
                            <div style="height: 250px; overflow-y: scroll; overflow-x: hidden;">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Номер" name="numberadd"
                                        required="required">
                                </div><br>
                                <span><b>Вид работы</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Вид работы" name="kindWorkadd"
                                        required="required">
                                </div><br>
                                <span><b>Задание выдал</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Задание выдал" name="jobGivenadd"
                                        required="required">
                                </div><br>
                                ...
                                <?php include("includes/outfitTaskActions/insertOutfitTask.php");?>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="editBtn" class="modalDialog">
                        <div class="editRecord" >
                            ...
                            <span><b>Дата</b></span>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="number" class="form-control" placeholder="Номер" name="numberEdit"
                                        required="required">
                                </div><br>
                                <span><b>Вид работы</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Вид работы" name="kindWorkEdit"
                                        required="required">
                                </div><br>
                                <span><b>Задание выдал</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Задание выдал" name="jobGivenEdit"
                                        required="required">
                                </div><br>
                                <span><b>Состав бригады</b></span>
                                <div class="input-group">
                                ...
                                <?php include("includes/outfitTaskActions/editOutfitTask.php");?>
                            </form>
                        </div>
                    </div>
                </div>
