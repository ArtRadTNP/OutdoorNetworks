...
<body style="background-color: #F5FFFA;">
    <div id="main" style="padding: 0; margin-top: 8px; width: 100%; height: 90%;">
        <div class="m-content" style="width: 1520px; height: 665px;">
            ...
            <p><strong style="font-size:18px; font-family: 'Roboto', sans-serif;"><center>Паспорта</center></strong></p>
            <div class="datatable">
                    ...
                    <?php
                        ...
                        echo "<table id='table_blur' class='table_blur' style='width: 1450px; height: auto;'>
                                    ...
                                    <tr>
                                        ...
                                        <th>Паспорт</th>
                                        <th>Дата</th>
                                        <th>Место производимых работ</th>
                                        <th>Вид производимых работ</th>
                                        <th>Прочие сведения о производимых работах</th>
                                ...
                                echo "
                                    <tr class='table-data' style='text-align: center;'>
                                        <td>
                                            ...
                                            <form method='post' action='includes/passportsActions/removePassports.php'>
                                        ...
                                        <td id='placeWork'>" . $row['placeWork'] . "</td>
                                        <td id='typeWork'>" . $row['typeWork'] . "</td>
                                        <td id='etc'>" . $row['etc'] . "</td>
                                        <td id='persRespProd'>" . $row['persRespProd'] . "</td>
                                    </tr>
                                ";
                            }
                            echo "</table>";
                    ...
                    <div id="addBtn" class="modalDialog">
                        <div class="addRecord" >
                            ...
                            <div style="height: 250px; overflow-y: scroll; overflow-x: hidden;">
                                ...
                                <span><b>Место производимых работ</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Место производимых работ" name="placeWorkadd"
                                        required="required">
                                </div><br>
                                ...
                                <span><b>Прочие сведения о производимых работах</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Прочие сведения о производимых работах" name="etcadd"
                                        required="required">
                                </div><br>
                                <span><b>Ответсвенное лицо</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Ответсвенное лицо" name="persRespProdadd"
                                        required="required">
                                </div><br>
                                </div>
                                <center><button id="add" class="btn btn-info btn-lg" name="add" style="width: 300px; margin-top: 15px;">Добавить запись</button></center>
                                
                                <?php include("includes/passportsActions/insertPassports.php");?>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="editBtn" class="modalDialog">
                        <div class="editRecord" >
                            ...
                            <span><b>Паспорт</b></span>
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Место производимых работ" name="placeWorkEdit"
                                        required="required">
                                </div><br>
                                <span><b>Вид производимых работ</b></span>
                                <div class="input-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Прочие сведения о производимых работах" name="etcEdit"
                                        required="required">
                                </div><br>
                                <span><b>Ответсвенное лицо</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Ответсвенное лицо" name="persRespProdEdit"
                                        required="required">
                                </div><br>
                                </div>
                                ...
                                <?php include("includes/passportsActions/editPassports.php");?>
                            </form>
                        </div>
                    </div>
                </div>
