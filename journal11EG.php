...
<body style="background-color: #F5FFFA;">
    <div id="main" style="padding: 0; margin-top: 8px; width: 100%; height: 90%;">
        <div class="m-content" style="width: 1520px; height: 665px;">
            ...
            <p><strong style="font-size:18px; font-family: 'Roboto', sans-serif;"><center>Журнал 11-ЭГ</center></strong></p>
            <div class="datatable">
                    ...
                    <?php
                        ...
                        echo "<table id='table_blur' class='table_blur' style='width: 1450px; height: auto;'>
                                    ...
                                    <tr>
                                        <th></th>
                                        <th>Дата</th>
                                        <th>Наименование строительной организации, адрес производства работ, должность, фамилия руководителя работ</th>
                                        <th>Номер разрешения и срок действия</th>
                                        <th>Отметка о состоянии  контролируемого объекта, работ и мерах принятых по сохранности газопровода</th>
                                        <th>Фамилия, инициалы слесаря</th>
                                ...
                                echo "
                                    <tr class='table-data' style='text-align: center;'>
                                        <td>
                                            ...
                                            <form method='post' action='includes/journal11EGActions/removeJournal11EG.php'>
                                        ...
                                        <td id='permissNumber'>" . $row['permissNumber'] . "</td>
                                        <td id='statusMark'>" . $row['statusMark'] . "</td>
                                        <td id='locksInitials'>" . $row['locksInitials'] . "</td>
                                        <td id='methodapplic'>" . $row['methodapplic'] . "</td>
                                    </tr>
                                ";
                            }
                            echo "</table>";
                    ...
                    <div id="addBtn" class="modalDialog">
                        <div class="addRecord" >
                            ...
                            <div style="height: 250px; overflow-y: scroll; overflow-x: hidden;">
                                ...
                                <span><b>Наименование строительной организации, адрес производства работ, должность, фамилия руководителя работ</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Наименование строительной организации, адрес производства работ, должность, фамилия руководителя работ" name="titleadd"
                                        required="required">
                                </div><br>
                                <span><b>Номер разрешения и срок действия</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Номер разрешения и срок действия" name="permissNumberadd"
                                        required="required">
                                </div><br>
                                <span><b>Отметка о состоянии  контролируемого объекта, работ и мерах принятых по сохранности газопровода</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Отметка о состоянии  контролируемого объекта, работ и мерах принятых по сохранности газопровода" name="statusMarkadd"
                                        required="required">
                                </div><br>
                                <span><b>Фамилия, инициалы слесаря</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Фамилия, инициалы слесаря" name="locksInitialsadd"
                                        required="required">
                                </div><br>
                                <span><b>Способ внесения</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Способ внесения" name="methodapplicadd"
                                        required="required">
                                </div><br>
                                </div>
                                <center><button id="add" class="btn btn-info btn-lg" name="add" style="width: 300px; margin-top: 15px;">Добавить запись</button></center>
                                
                                <?php include("includes/journal11EGActions/insertJournal11EG.php");?>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="editBtn" class="modalDialog">
                        <div class="editRecord" >
                            ...
                            <div style="height: 250px; overflow-y: scroll; overflow-x: hidden;">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Наименование строительной организации, адрес производства работ, должность, фамилия руководителя работ" name="titleEdit"
                                        required="required">
                                </div><br>
                                <span><b>Номер разрешения и срок действия</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Номер разрешения и срок действия" name="permissNumberEdit"
                                        required="required">
                                </div><br>
                                <span><b>Отметка о состоянии  контролируемого объекта, работ и мерах принятых по сохранности газопровода</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Отметка о состоянии  контролируемого объекта, работ и мерах принятых по сохранности газопровода" name="statusMarkEdit"
                                        required="required">
                                </div><br>
                                <span><b>Фамилия, инициалы слесаря</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Фамилия, инициалы слесаря" name="locksInitialsEdit"
                                        required="required">
                                </div><br>
                                <span><b>Способ внесения</b></span>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                    <input type="text" class="form-control" placeholder="Способ внесения" name="methodapplicEdit"
                                        required="required">
                                </div><br>
                                </div>
                                ...
                                <?php include("includes/journal11EGActions/editJournal11EG.php");?>
                            </form>
                        </div>
                    </div>
                </div>
