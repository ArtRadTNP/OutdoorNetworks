...
<body style="background-color: #F5FFFA;">
    <div id="main" style="padding: 0; margin-top: 8px; width: 100%; height: 90%;">
        <div class="m-content" style="width: 1520px; height: 665px;">
            ...
            <p><strong style="font-size:18px; font-family: 'Roboto', sans-serif;"><center>Наряд-задание КЗР</center></strong></p>
            <div class="datatable">
                <div align="center" style="height:100%; width: auto;overflow-y:scroll;">
                    <?php
                        ...
                        $query ="SELECT * FROM outfittaskkzr";
                                ...
                                echo "
                                    <tr class='table-data' style='text-align: center;'>
                                        <td>
                                            ...
                                            <form method='post' action='includes/outfitTaskKZRActions/removeOutfitTaskKZR.php'>
                    ...
                    <div id="addBtn" class="modalDialog">
                        <div class="addRecord" >
                            ...
                            <div style="height: 250px; overflow-y: scroll; overflow-x: hidden;">
                                ...
                                <?php include("includes/outfitTaskKZRActions/insertOutfitTaskKZR.php");?>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="editBtn" class="modalDialog">
                        <div class="editRecord" >
                            ...
                            <span><b>Дата</b></span>
                                ...
                                <?php include("includes/outfitTaskKZRActions/editOutfitTaskKZR.php");?>
                            </form>
                        </div>
                    </div>
                </div>
